...
#SBATCH --job-name=impute_phase_two_pop
#SBATCH --mail-type=FAIL
#SBATCH --mail-user=kj.benjamin90@gmail.com
#SBATCH --ntasks-per-node=64
#SBATCH --array=0-2
#SBATCH --time=12:00:00
#SBATCH --output=logs/impute_phased.two_pop.%A_%a.log
...
PHASED_DIR="input/simulations/two_populations/_m/rfmix-out/phased_files"

python ../_h/03.impute_phased.py \
       --rfmix-input "$RFMIX_DIR" \
       --phased_zarr "$PHASED_DIR" \
       --population "two" --method "$METHOD"
