...
#SBATCH --job-name=impute_phase_three_pop
#SBATCH --mail-type=FAIL
#SBATCH --mail-user=kj.benjamin90@gmail.com
#SBATCH --ntasks-per-node=64
#SBATCH --array=0-2
#SBATCH --time=12:00:00
#SBATCH --output=logs/impute_phased.three_pop.%A_%a.log
...
PHASED_DIR="input/simulations/three_populations/_m/rfmix-files/phased_files"
