...
#SBATCH --mem=24gb
#SBATCH --output=logs/summary.%A-%a.log
#SBATCH --array=2-22
...
java -Xmx24g -jar $SOFTWARE/flare.jar \
     ...
     gt="${QUERY_DIR}/_m/${QUERY_VCF}" nthreads=$THREADS em=false \
     seed=13131313 model="chr1.model" array=true out="chr${CHROM}"
