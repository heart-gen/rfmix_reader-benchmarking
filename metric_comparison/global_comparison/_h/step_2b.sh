...
#SBATCH --job-name=phased_global_two_pop
#SBATCH --mail-type=FAIL
#SBATCH --mail-user=kj.benjamin90@gmail.com
#SBATCH --ntasks-per-node=16
#SBATCH --time=03:00:00
#SBATCH --array=1-22
#SBATCH --output=logs/phased_global.two_pop.%A_%a.log
...
FLARE_DIR="input/simulations/two_populations/_m/flare-out"
SAMPLE_ANNOT="input/references/_m/two_populations/reference_zarr/samples_id2"
REF_DIR="input/references/_m/two_populations/reference_zarr"
